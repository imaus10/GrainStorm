...
class GrainStorm extends Component {
  ...
  , [ <div key="1"><p>Start the cloud by pressing the play button.</p></div>, false ]
  , [ <div key="2">
  ...
  , [ <div key="7"><p>Try changing the pitch of the sample.</p></div>, true ]
  , [ <div key="8">
  ...
  , [ <div key="17"><p>There's a new button above! It will add another grain source, this time using a pure sound wave instead of a sampled sound. Click it!</p></div>, false ]
  , [ <div key="18"><p>Wave form grains have many of the same parameters, but frequency and wave type are unique to wave forms.</p></div>, true ]
  , [ <div key="19">
        <p>Two more things -- </p>
